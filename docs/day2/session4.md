...
고정된 명령어가 아닌, 들어오는 데이터에 따라 변하는 **동적 프롬프트**를 작성할 수 있습니다.
...
> **Tip:** 데이터가 들어가는 자리에 `{{ ... }}` 변수를 드래그 앤 드롭으로 배치할 수 있습니다.

---

### 3. 구조화된 출력(Structured Output) 만들기
...
* 위에서 배운 **프롬프트** 를 System Message 로 사용.
