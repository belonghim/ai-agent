...
3. **Container port** 임의 지정 (예: 19090 포트)
4. **Create GPU enabled machine** 버튼 클릭
5. **Create Service** 클릭
6. **Open Service Details** 클릭 후, **Endpoint 확인:** `http://localhost:19090/v1`
* * n8n 'OpenAI Chat Model' 노드를 위한 설정 시에는 컨테이너 내에서 호출되므로, http://host.containers.internal:19090/v1 로 바꿔서 기록해놓으세요.*
