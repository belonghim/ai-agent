...
기존 Session 3의 커리큘럼(기본기 다지기)을 유지하면서, 앞서 Session 1에서 구축한 **Local LLM(Podman AI Lab)**을 n8n에 실제로 연동해보는 실습 단계를 자연스럽게 추가했습니다.

n8n의 기초인 **Mapping(데이터 연결)** 개념을 익힌 직후, 그 데이터를 AI에게 던져주는 흐름으로 구성하면 학습 효과가 매우 높습니다.
