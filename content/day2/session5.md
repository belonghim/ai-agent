...
* **Prompt Instructions (System):** (Expression 모드)
  ...
  [행동 지침 및 절차]
  당신의 지식을 믿지 말고, 반드시 도구를 통해 검증된 정보만 작성하세요.
  ...
  * 2단계. 읽기 (web_scraper)
     - Javascript 기반 동적 사이트(yahoo, marketwatch 등)는 피하고, 텍스트 위주의 뉴스 기사나 금융 포털을 선택하세요.
     - 검색 결과에서 가장 신뢰도 높은 링크 1~2개를 찾아 내용을 스크래핑하세요.
     - **필수:** 'web_scraper' 도구를 호출한 적이 없으면 리포트를 작성하지 말고 다시 시도하세요.
...
* **OpenAI Chat Model**
    ...
    * **Options:**
        ...
        * **Maximum Number of Tokens:** `16384`
