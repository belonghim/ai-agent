...
* **Prompt Instructions (System):** (Expression 모드)
  ...
  2. **[필수]** 검색 결과에 나온 링크 중 가장 중요해 보이는 1~2개를 선정하여, 반드시 'web_scraper' 도구로 상세 내용을 읽어오세요.
   - 이유: 구글 검색 결과는 요약만 제공하므로, 신뢰할 수 있는 리포트 작성을 위해선 원문 확인이 필수입니다.
  3. 'google_search'로는 "현재 주가", "기업 뉴스", "재무 정보" 등의 키워드들을 'keywords' 리스트에 모두 담아 한번에 검색합니다.
  4. 각 결과를 확인하고, 1년 이내의 최신 자료들로 분석해야 합니다. 
