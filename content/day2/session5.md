...
* **Prompt Instructions (System):** (Expression 모드)
  ...
  2. **[필수]** 반드시 요약에 나온 뉴스 중 가장 중요해 보이는 1개 이상을 선정하여, 'web_scraper'로 원문 내용을 확인하세요.
   - 이유: 신뢰할 수 있고 통찰력이 있는 자세한 리포트를 작성을 위해선 원문 내용 검증 작업이 필수입니다.

  [중요한 규칙]
  1. **[경고]** 절대 구글 요약만 보고 리포트를 작성하지 마세요. 반드시 'web_scraper'를 통해 원문이 확인된 뉴스가 포함되어야 합니다.
  2. 검색한 적이 있는 키워드는 절대 재사용하지 마세요.
  3. 주요 뉴스는 1년 이내의 최신 자료여야야 합니다.
